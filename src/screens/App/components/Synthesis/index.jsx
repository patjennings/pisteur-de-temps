		...
		<div className="col-12 synthesis-inner">
		  <div className="row synthesis-search">
		    <div className="col-2 offset-5">
		      <input className="form-control form-control-dark w-100 mb-4 mt-4" type="text" placeholder={this.props.mainStore.appStrings[this.props.mainStore.lang.toLowerCase()].synthesis.search} aria-label="Search" onChange={this.handleChange}/>
		    </div>
		  </div>
